...
import { ICourseContentItem } from "./CreateCourse";
  ...
  return (
    <div className="w-[90%] m-auto py-5 mb-5 text-black dark:text-white">
      <div className="w-full relative">
        ...
        <div className="flex items-center">
          <div
            className={`${styles.button} w-45! my-3 font-Poppins bg-[crimson]! cursor-not-allowed dark:bg-[#b91c1c]! dark:text-white!`}
          >
      ...
      <div className="w-full">
        ...
        {courseData?.benefits?.map((item: CourseItem, index: number) => (
          <div className="w-full flex 800px:items-center py-2" key={index}>
            <div className="w-3.75 mr-1 text-[#37a39a] dark:text-[#3ccba0]">
        ...
        {courseData?.prerequisites?.map((item: CourseItem, index: number) => (
          <div className="w-full flex 800px:items-center py-2" key={index}>
            <div className="w-3.75 mr-1 text-[#37a39a] dark:text-[#3ccba0]">
              <IoCheckmarkDoneOutline size={20} />
            </div>
